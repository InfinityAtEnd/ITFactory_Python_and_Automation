Feature: Test the search functionality in the homepage of Ebay
  ...
  Scenario Outline: Check that the user can add a product to shopping cart
    ...
    Examples:
      ...
      | iphone max 10 pro | Cell Phones & Accessories     | Model      | For iPhone 12 | Color      | T9      | None       | None    | None       | None    |
      | blouse            | Clothing, Shoes & Accessories | Color      | Yellow        | Size       | XL      | None       | None    | None       | None    |